...
from MHADQN.model import MHADQN   # ajustado para o novo pacote MHADQN
...
def train(cfg_path: str):
    ...
    models_dir = os.path.join("Models", "MHADQN")
    ...
    for episode in pbar:
        ...
        while not done:
            # forward will auto-resample noise in NoisyLinear
            ...
            if len(replay_buffer) >= cfg['batch_size']:
                ...
                with torch.no_grad():
                    # auto-resample noise in target forward
