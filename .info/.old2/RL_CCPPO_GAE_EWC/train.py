...
from RL_CCPPO_GAE_EWC.model import PPOAgent
...
class HyperParameters:
    def __init__(self, param_path: str, model_path: str):
        ...
        self.lambda_ewc      = agent_cfg.get('lambda_ewc', 100)  # Novo hiperparâmetro
...
if __name__ == "__main__":
    ...
    model_path = 'RL_CCPPO_GAE_EWC/model.json'
    fisher_save_path = "models/ewc/fisher_theta_last.pt"
    ...
    # Salva Fisher/Theta_star para próxima janela
