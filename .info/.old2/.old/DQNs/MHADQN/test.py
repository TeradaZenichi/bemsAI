...
from MHADQN.model import MHADQN
...
def main(cfg_path: str, model_path: str):
    ...
    plt.tight_layout()
    plt.savefig('mh_dqn_plot.png')
    plt.show()
    plt.close(fig)

if __name__ == '__main__':
    main(cfg_path='MHADQN/model.json', model_path='Models/MHADQN/attentiondqn_energy.pth')
