...
def run_episode(env, model, device):
    ...
    while not done:
        # reset noise for dueling network exploration
        model.reset_noise()
...
if __name__ == '__main__':
    main(cfg_path='DuelingDQN/model.json', model_path='Models/DuelingDQN/duelingdqn_energy.pth')
